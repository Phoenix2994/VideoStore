...
export const MOVIES: Movie[] = [
  ...
  { title: 'Titanic', year: 1997, genre: 'Romantico', movieDirector: 'James Cameron', duration: 195, plot},
  { title: 'I Simpson ', year: 2007, genre: 'Commedia', movieDirector: 'David Silverman', duration: 87, plot },
  { title: 'Jurassic Park', year: 1997, genre: 'Avventura', movieDirector: 'Steven Spielberg', duration: 127, plot},
  { title: 'Non ci resta che piangere', year: 1984, genre: 'Commedia', movieDirector: 'Massimo Troisi', duration: 145, plot},
